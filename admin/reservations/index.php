<div class="card card-outline card-primary" style="border: none; box-shadow: 1px 1px 5px black;">
	<div class="card-header">
		<h3 class="card-title" style="font-weight: bold;">Reservations</h3>
	</div>
	<div class="card-body">
        ...
        <div class="container-fluid">
			<table class="table table-hover table-striped table-bordered">
				...
				<thead>
					<tr style="background-color: #153462; color: white; border: none;">
						<th>Seat No.</th>
						<th>Schedule</th>
						<th>Schedule No.</th>
						<th>Passenger</th>
				...
				<tbody>
					...
					?>
						<tr>
							...
							<td class=""><p class="truncate-1"><?php echo ucwords($row['lastname'].'
							 '.$row['firstname'].' '.$row['middlename']) ?></p></td>
