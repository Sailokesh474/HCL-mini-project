...
<div class="card card-outline card-primary rounded-0 shadow" style="border: none;">
	<div class="card-header">
		...
		<div class="card-tools">
			<a href="javascript:void(0)" style="background-color: #153462; border: none; border-radius: 5px; box-shadow: 1px 1px 5px black; font-weight: bold;" id="create_new" class="btn btn-flat btn-sm btn-primary"><span class="fas fa-plus"></span>  Add Train</a>
		</div>
	</div>
	<div class="card-body">
			...
			<table class="table table-bordered table-hover table-striped">
				...
				<thead>
					<tr class="bg-gradient-primary text-light">
						<th style="background-color: #153462; color: white;">S.no</th>
						<th style="background-color: #153462; color: white;">Date Created</th>
						<th style="background-color: #153462; color: white;">Train No.</th>
						<th style="background-color: #153462; color: white;">Name</th>
						<th style="background-color: #153462; color: white;">Capacity</th>
						<th style="background-color: #153462; color: white;">Controls</th>
					</tr>
				</thead>
				<tbody>
					<?php 
