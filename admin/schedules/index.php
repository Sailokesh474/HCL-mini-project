...
<div class="card card-outline card-primary rounded-0 shadow" style="border: none;">
	<div class="card-header">
		...
		<div class="card-tools">
			<a href="javascript:void(0)" id="create_new" style="background-color: #153462; border: none; border-radius: 5px; box-shadow: 1px 1px 5px black; font-weight: bold;" class="btn btn-flat btn-sm btn-primary"><span class="fas fa-plus"></span>  Add Schedule</a>
		</div>
	</div>
	<div class="card-body">
        <div class="container-fluid">
			...
			<table class="table table-hover table-striped table-bordered">
				...
				<thead>
					<tr style="background-color: #153462; color: white;">
						<th>Schedule No</th>
						<th>Schedules</th>
						<th>Routes</th>
						<th>Train Name</th>
						<th>Fares/Capacities</th>
						<th>Controls</th>
					</tr>
				</thead>
				<tbody>
