...
<div class="card card-outline card-primary" style="border: none;">
	<div class="card-header">
		...
		<div class="card-tools">
			<a href="?page=user/manage_user" style="background-color: #153462; border: none; border-radius: 5px; box-shadow: 1px 1px 5px black; font-weight: bold;" class="btn btn-flat btn-primary"><span class="fas fa-plus"></span>  Create New</a>
		</div>
	</div>
	<div class="card-body">
