...
<div class="content py-5">
    <div class="card rounded-0 card-outline card-primary shadow" style="border: none;">
        <div class="card-header rounded-0">
            <h5 class="card-title" style="font-weight: bold;">Tickets Generated</h5>
            <div class="card-tools">
                <button class="btn btn-sm btn-flat btn-success" style="background-color: #153462; border: none; border-radius: 5px; box-shadow: 1px 1px 5px black; font-weight: bold;" id="print"><i class="fa fa-print"></i> Print</button>
            </div>
        </div>
