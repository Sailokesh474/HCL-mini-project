...
<div class="content py-5">
    <div class="row justify-content-center" style="box-shadow: 1px 1px 5px black; ">
        <div class="col-md-12" >
            <div class="card card-outline card-primary rounded-0 shadow" style="border: none;">
                <div class="card-body" >
                    
                    <div class="callout border-primary rounded-0 shadow" style="border: none; box-shadow: 1px 1px 10px black;">
                        <fieldset >
                            <legend class="text-muted" style="font-weight: bold;" >Schedule</legend>
                            <form action="" id="filter-schedule">
                                <div class="row align-items-end">
                                    ...
                                    <div class="col-md-3 col-sm-4">
                                        <button class="btn btn-flat btn-primary" style="border: none; border-radius: 5px; background-color: #153462;"><i class="fa fa-search"></i> Search</button>
                                    </div>
                                </div>
                            </form>
                        </fieldset>
                    ...
                    <table class="table table-hover table-striped table-bordered">
                        ...
                        <thead>
                            <tr class="bg-gradient-primary text-light">
                                <th style="background-color: #153462;">Schedule no.</th>
                                <th style="background-color: #153462;">Schedules</th>
                                <th style="background-color: #153462;">Routes</th>
                                <th style="background-color: #153462;">Train</th>
                                <th style="background-color: #153462;">Slots/Rates</th>
                                <th style="background-color: #153462;">Bookings</th>
                            </tr>
                        </thead>
                        <tbody>
                            <?php 
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td class="px-0">
                                        <div class="px-1 border-bottom"><span class="text-muted">First Class:</span> <span class="text-muted fa fa-user"></span> <b><?= $row['type'] == 1 ? "" : number_format($fc_slot) ?></b> <span class="text-muted ml-2 fa fa-tag"></span> <b><?= rtrim(number_format($row['first_class_fare'],2),'.') ?></b></div>
                                        <div class="px-1"><span class="text-muted">Economy:</span> <span class="text-muted fa fa-user"></span> <b><?= $row['type'] == 1 ? "" : number_format($e_slot) ?></b> <span class="text-muted ml-2 fa fa-tag"></span> <b><?= rtrim(number_format($row['economy_fare'],2),'.') ?></b></div>
                                    </td>
                                    <td class="px-1" align="center">
                                        <a href="./?page=reserve&sid=<?= $row['id'] ?>" class="btn btn-flat btn-primary btn-sm" style="background-color: #153462; border: none; border-radius: 5px; box-shadow: 1px 1px 5px black;" >Book <i class="fa fa-angle-right"></i></a>
                                    </td>
                                </tr>
                            <?php endwhile; ?>
                        </tbody>
