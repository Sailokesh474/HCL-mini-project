        ...
        <div class="d-flex justify-content-between w-100">
          <div>
            ...
            <?php if($_settings->userdata('login_type') == 1): ?>
              <span class="mx-1"><a href="<?= base_url.'classes/Login.php?f=logout' ?>"><i class="fa-solid fa-right-from-bracket"></i></a></span>
            <?php else: ?>
              <span class="mx-1"><a href="<?= base_url.'classes/Login.php?f=client_logout' ?>"><i class="fa fa-power-off"></i></a></span>
            <?php endif; ?>
            <?php else: ?>
              <a href="./admin" class="mx-2 text-light" style="font-weight: bold;"> Admin</a>
            <?php endif; ?>
          </div>
        </div>
      </nav>
